...
chmod +x joystick/set_joy_perms.sh
chmod +x joystick/start_joy_node.sh
chmod +x build_ws.sh
chmod +x use_ws.sh
chmod +x start_nodes.sh
chmod +x create_cpp_pkg.sh
chmod +x create_pkg_lang.sh
chmod +x create_py_pkg.sh
chmod +x create_cpp_pkg.sh
chmod +x view_rviz.sh
